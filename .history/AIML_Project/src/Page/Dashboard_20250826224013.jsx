        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <SectionCard className="lg:col-span-2">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 mt-6">
              <img src={cnnDiagram} alt="CNN Diagram" className="h-32 w-auto rounded shadow" />
              <img src={lungCt} alt="Lung CT" className="h-32 w-auto rounded shadow" />
              <img src={lungXray} alt="Lung X-ray" className="h-32 w-auto rounded shadow" />
            </div>
