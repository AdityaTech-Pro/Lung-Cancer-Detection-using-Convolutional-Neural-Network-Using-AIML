        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <SectionCard className="lg:col-span-2">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-6">
              <img src={lungXray} alt="Lung X-ray" className="h-20 rounded shadow w-15" />
              <br><p className="text-xs text-slate-500">Lung X-ray</p></br>
              <img src={lungCt} alt="Lung CT" className="h-20 rounded shadow w-17" />
              <p className="text-xs text-slate-500">Lung CT</p>
              <img src={cnnDiagram} alt="CNN Diagram" className="h-20 rounded shadow w-17" />
