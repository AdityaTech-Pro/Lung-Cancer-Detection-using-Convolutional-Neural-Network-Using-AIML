    ...
    <div className="min-h-screen" id="home">
      ...
      <section id="about" className="flex justify-center px-4 py-20 bg-black/60">
          <div className="w-full max-w-5xl text-center">
            <h2 className="mb-10 text-3xl font-bold">Meet Our Team</h2>
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 justify-items-center">
              ...
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/67mNJMnR/Whats-App-Image-2025-07-17-at-15-57-25-659fea5d.jpg" alt="Shivansh Mittal" className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
                <h3 className="text-xl font-semibold">Shivansh Mittal</h3>
                <p className="text-purple-300">Founder & Developer</p>
                <p className="mt-2 text-sm text-gray-300">Tech visionary turning bold ideas into scalable products</p>
                <a href="mailto:shivanshmittalsde@gmail.com" className="block mt-2 text-purple-400 hover:underline">✉ shivanshmittalsde@gmail.com</a>
                <a href="https://www.linkedin.com/in/ishivxnshh " className="block mt-2 text-purple-400 hover:underline">LinkedIn</a>
              </div>
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/yck71YCH/Whats-App-Image-2025-07-17-at-16-54-01-c82fb624.jpg" alt="Vijay K.S" className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
                <h3 className="text-xl font-semibold">Vijay K.S</h3>
                <p className="text-purple-300">Founder & Developer</p>
                <p className="mt-2 text-sm text-gray-300">Command, Creater, Conquer.</p>
                <a href="mailto:ksvijay2005@gmail.com" className="block mt-2 text-purple-400 hover:underline">✉ ksvijay2005@gmail.com</a>
                <a href="https://www.linkedin.com/in/vj-ks/" className="block mt-2 text-purple-400 hover:underline">LinkedIn</a>
              </div>
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/SXk3XFmd/Whats-App-Image-2025-07-17-at-17-27-50-4d4c97ec.jpg" alt="Dikshant Raj" className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
                <h3 className="text-xl font-semibold">Dikshant Raj</h3>
                <p className="text-purple-300">Founder & Developer</p>
                <p className="mt-2 text-sm text-gray-300">Frontend developer with a passion for scalable systems.</p>
                <a href="mailto:rajdikshant07@gmail.com" className="block mt-2 text-purple-400 hover:underline">✉ rajdikshant07@gmail.com</a>
                <a href="http://www.linkedin.com/in/dikshant-raj" className="block mt-2 text-purple-400 hover:underline">LinkedIn</a>
              </div>
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/rRZXxnQ0/Whats-App-Image-2025-07-17-at-21-42-28-73b21e27.jpg" alt="Surya Pranav SR " className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
                <h3 className="text-xl font-semibold">Surya Pranav SR </h3>
                <p className="text-purple-300">Founder & Developer</p>
                <p className="mt-2 text-sm text-gray-300">Ideas, Code, Impact.</p>
                <a href="mailto:suryapranav.official@gmail.com" className="block mt-2 text-purple-400 hover:underline">✉ suryapranav.official@gmail.com</a>
                <a href="http://www.linkedin.com/in/surya-pranav-2k5" className="block mt-2 text-purple-400 hover:underline">LinkedIn</a>
              </div>
            </div>
          </div>
        </section>
