...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen" id="home">
      ...
      <section id="about" className="flex items-center justify-center min-h-[60vh] px-4 py-20 bg-black/60">
        <div className="w-full max-w-5xl flex flex-col items-center justify-center text-center">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 justify-items-center">
            <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10 flex flex-col items-center">
              <img src="https://i.ibb.co/SXD8y4Sy/IMG-20250717-WA0017.jpg" alt="Aditya Verma" className="mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
