      ...
      <section id="about" className="flex justify-center px-4 py-20 bg-black/60">
          <div className="w-full max-w-5xl text-center">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 justify-items-center">
              ...
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/SXD8y4Sy/IMG-20250717-WA0017.jpg" alt="Dhruv" className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
              ...
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/SXD8y4Sy/IMG-20250717-WA0017.jpg" alt="Ahana" className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
              ...
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/SXD8y4Sy/IMG-20250717-WA0017.jpg" alt="Anju" className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
              ...
              <div className="w-full max-w-xs p-6 border border-gray-500 rounded-lg bg-white/10">
                <img src="https://i.ibb.co/SXD8y4Sy/IMG-20250717-WA0017.jpg" alt="Shalu" className="mx-auto mb-4 border-2 border-purple-500 rounded-full w-25 h-28" />
                <h3 className="text-xl font-semibold">Shalu</h3>
                <p className="text-purple-300">Partner</p>
                <p className="mt-2 text-sm text-gray-300">AI and Startups and 😎Here working as Backend Developer.</p>
                <a href="mailto:9905adityaverma@gmail.com" className="block mt-2 text-purple-400 hover:underline">✉ 9905adityaverma@gmail.com</a>
                <a href="https://www.linkedin.com/in/aditya-verma-2a3915289/" className="block mt-2 text-purple-400 hover:underline">LinkedIn</a>
              </div>
